...
weapon_key = ["名称","种类","使用时长(h)","击杀","KPM","命中率","爆头率","效率"]
vehicle_key = ["名称","种类","击杀","KPM","摧毁","驾龄(h)"]
...
def ImageStats(data,top_5_weapons,top_5_vehicles):
    ...
    # 矩形的坐标，这里以左上角和右下角坐标来表示
    # 例如：(x1, y1, x2, y2) 表示矩形左上角坐标为(x1, y1)，右下角坐标为(x2, y2)
...
#vehicle_key = ["名称","种类","击杀","KPM","摧毁","驾龄"]
